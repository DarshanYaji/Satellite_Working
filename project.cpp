...
{     glClearColor(0.4,0.3,0.6,1.0);
	...
	drawstring(-1.7,3.0,0.0,"SDMIT UJIRE,DEPARTMENT OF COMPUTER SCIENCE");
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(0.0,1.0,1.0);
	drawstring(-3.0,2.5,0.0,"                         Computer Graphics Mini Project on WORKING OF THE SATELLITE");
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(-1,2,0,"      Using OPENGL");
        ...
        setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(-3,1.5,0,"By:");

	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(-3,1,0,"Chethan R (4SU16CS026)");

	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(-3,.5,0,"Darshan B Yaji (4SU16CS027)");



        setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(1,1.5,0,"Guided By:");

	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
        glColor3f(0.0,1.0,1.0);
	drawstring(1,1,0,"Ms.Sneha Shetty R");

	

	

	drawstring(-3.5,-3,0,"  ( Press s to continue )");
	drawstring(-0.5,-3,0,"( Press t to transmit )");
        glColor3f(1.0,0.0,0.0);
	drawstring(3,-3,0,"( Press q to quit )");
